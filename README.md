...
- 🏠 [Gajyun Portal](https://github.com/Remisu/gajyun-portal):  
  Work schedule and task management for hostels. Built with **React, Firebase**, and **Firestore**.

- 🧾 [Gajyun ETL](https://github.com/Remisu/GajyunETL):  
  Automates passport data collection and eliminates paper usage using **C#** and **.NET**.

---

### 🌱 Currently Learning
☁️ Cloud Architecture (GCP, serverless apps)  
📊 Data pipelines with BigQuery and ETL automation  
🇯🇵 Japanese – JLPT N3 preparation  

---

### 📫 Connect with me
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-blue?logo=linkedin)](https://www.linkedin.com/in/emerson-miguel/)
